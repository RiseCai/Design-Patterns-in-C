...
<body>
    <div class="container">
        <h1>System Coordinator State Diagram (with API Mapping)</h1>
        <p>This diagram shows the system coordinator FSM with API calls and subsystem activation.</p>
        <div class="diagram">
            {svg_content}
        </div>
        <div class="note">
        ...
        <div class="links">
            <a href="system_coordinator_with_all_subsystems.html">All Subsystems Diagram</a>
...
if __name__ == '__main__':
    puml = 'system_coordinator_state_diagram_with_api.puml'
    html = 'system_coordinator_state_diagram_with_api.html'
